...
public class EmployeeBankController extends CommonCatalogController {
	...
	@PostMapping
	public ResponseEntity<ResponseDTO> create(@Valid @RequestBody EmployeeBankDTO entity, BindingResult result) 
	...
	@PutMapping(ID)
	public ResponseEntity<ResponseDTO> edit(@Valid @RequestBody EmployeeBankDTO entity, BindingResult result, @PathVariable Long id) 
