...
public class ProspectStatusController extends CommonCatalogController {
	...
	@PostMapping
	public ResponseEntity<ResponseDTO> create(@Valid @RequestBody ProspectStatusDTO entity, BindingResult result) 
	...
	@PutMapping(ID)
	public ResponseEntity<ResponseDTO> edit(@Valid @RequestBody ProspectStatusDTO entity, BindingResult result, @PathVariable Long id) 
