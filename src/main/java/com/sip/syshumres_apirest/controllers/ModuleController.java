...
public class ModuleController extends CommonController {
	...
	public ResponseEntity<Page<ModuleDTO>> list(@RequestParam String q, Pageable pageable) {
	...
	public ResponseEntity<Page<ModuleDTO>> list(@RequestParam String q, Pageable pageable, Sort sort) {
