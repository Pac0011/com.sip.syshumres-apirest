...
public class EmployeeTypeHealthController extends CommonCatalogController {
	...
	@PostMapping
	public ResponseEntity<ResponseDTO> create(@Valid @RequestBody EmployeeTypeHealthDTO entity, BindingResult result) 
	...
	@PutMapping(ID)
	public ResponseEntity<ResponseDTO> edit(@Valid @RequestBody EmployeeTypeHealthDTO entity, BindingResult result, @PathVariable Long id) 
