...
public class SchoolGradeCompleteController extends CommonCatalogController {
	...
	@PostMapping
	public ResponseEntity<ResponseDTO> create(@Valid @RequestBody SchoolGradeCompleteDTO entity, BindingResult result) 
	...
	@PutMapping(ID)
	public ResponseEntity<ResponseDTO> edit(@Valid @RequestBody SchoolGradeCompleteDTO entity, BindingResult result, @PathVariable Long id) 
