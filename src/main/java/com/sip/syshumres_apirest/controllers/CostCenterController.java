...
public class CostCenterController extends CommonController {
	...
	public ResponseEntity<Page<CostCenterDTO>> list(@RequestParam String q, Pageable pageable) {
	...
	public ResponseEntity<Page<CostCenterDTO>> list(@RequestParam String q, Pageable pageable, Sort sort) {
