...
public class DinningRoomController extends CommonCatalogController {
	...
	@PostMapping
	public ResponseEntity<ResponseDTO> create(@Valid @RequestBody DinningRoomDTO entity, BindingResult result) 
	...
	@PutMapping(ID)
	public ResponseEntity<ResponseDTO> edit(@Valid @RequestBody DinningRoomDTO entity, BindingResult result, @PathVariable Long id) 
