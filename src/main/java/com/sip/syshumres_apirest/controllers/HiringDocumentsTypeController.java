...
public class HiringDocumentsTypeController extends CommonCatalogController {
	...
	@PostMapping
	public ResponseEntity<ResponseDTO> create(@Valid @RequestBody HiringDocumentsTypeDTO entity, BindingResult result) 
	...
	@PutMapping(ID)
	public ResponseEntity<ResponseDTO> edit(@Valid @RequestBody HiringDocumentsTypeDTO entity, BindingResult result, @PathVariable Long id) 
