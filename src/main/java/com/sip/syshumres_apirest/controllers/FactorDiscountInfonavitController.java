...
public class FactorDiscountInfonavitController extends CommonCatalogController {
	...
	@PostMapping
	public ResponseEntity<ResponseDTO> create(@Valid @RequestBody FactorDiscountInfonavitDTO entity, BindingResult result) 
	...
	@PutMapping(ID)
	public ResponseEntity<ResponseDTO> edit(@Valid @RequestBody FactorDiscountInfonavitDTO entity, BindingResult result, @PathVariable Long id) 
